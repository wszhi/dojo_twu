...
public class DateParserTest {
    ...
    public void shouldThrowExceptionIfYearStringCannotBeParsed() {
        try {
            new DateParser("111").parse(new DateValidator());
    ...
    public void shouldThrowExceptionIfYearIsNotInteger() {
        try {
            new DateParser("abcd").parse(new DateValidator());
    ...
    public void shouldThrowExceptionIfYearIsLessThan2000() {
        try {
            new DateParser("1999").parse(new DateValidator());
    ...
    public void shouldThrowExceptionIfMonthStringCannotBeParsed() {
        try {
            new DateParser("2012-1").parse(new DateValidator());
    ...
    public void shouldThrowExceptionIfMonthIsNotInteger() {
        try {
            new DateParser("2012-ab").parse(new DateValidator());
    ...
    public void shouldThrowExceptionIfMonthIsMoreThan12() {
        try {
            new DateParser("2012-13").parse(new DateValidator());
    ...
    public void shouldThrowExceptionIfDateStringCannotBeParsed() {
        try {
            new DateParser("2012-12-1").parse(new DateValidator());
    ...
    public void shouldThrowExceptionIfDateIsNotInteger() {
        try {
            new DateParser("2012-12-ab").parse(new DateValidator());
    ...
    public void shouldThrowExceptionIfDateIsMoreThan31() {
        try {
            new DateParser("2012-12-32").parse(new DateValidator());
    ...
    public void shouldThrowExceptionIfHourStringCannotBeParsed() {
        try {
            new DateParser("2012-12-11T0").parse(new DateValidator());
    ...
    public void shouldThrowExceptionIfHourIsNotInteger() {
        try {
            new DateParser("2012-12-30Tab").parse(new DateValidator());
    ...
    public void shouldThrowExceptionIfHourIsMoreThan23() {
        try {
            new DateParser("2012-12-31T24").parse(new DateValidator());
    ...
    public void shouldThrowExceptionIfMinuteStringCannotBeParsed() {
        try {
            new DateParser("2012-12-11T01:1").parse(new DateValidator());
    ...
    public void shouldThrowExceptionIfMinuteIsNotInteger() {
        try {
            new DateParser("2012-12-30T01:ab").parse(new DateValidator());
    ...
    public void shouldThrowExceptionIfMinuteIsMoreThan59() {
        try {
            new DateParser("2012-12-31T23:60").parse(new DateValidator());
    ...
    public void shouldParseDateForValidInput() {
        ...
        Date result = new DateParser("2012-12-31T23:59Z").parse(new DateValidator());
